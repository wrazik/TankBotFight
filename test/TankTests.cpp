...
TEST_F(TankTest, SetSpeed_ShouldMoveDown) {
...
TEST_F(TankTest, Rotate180Degree_ShouldMoveUp) {
...
TEST_F(TankTest, Rotate270Degree_ShouldMoveRight) {
...
TEST_F(TankTest, RotateBody_ShouldAffectMoving) {
  ...
  EXPECT_PRED_FORMAT2(testing::FloatLE, 0.f, x);
  EXPECT_PRED_FORMAT2(testing::FloatLE, y, 10.f);
}
